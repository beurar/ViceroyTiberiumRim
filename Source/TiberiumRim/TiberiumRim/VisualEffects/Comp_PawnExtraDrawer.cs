...
namespace TiberiumRim
{
    ...
    public class Comp_PawnExtraDrawer : ThingComp
    {
        ...
        public void DrawExtraLayers(Pawn pawn, Vector3 drawPos, Quaternion rotation, bool renderBody, Rot4 bodyFacing, Rot4 headFacing, bool portrait, bool headStump)
        {
            foreach (var graphicPair in graphicData)
            {
                ...
                */
                ...
                if (!pawn.def.race.Humanlike)
                    ...
                    DrawOntoHuman(pawn, head, body, drawPos, rotation, renderBody, bodyFacing, headFacing, portrait, headStump, drawMirrored);
            }
        }
