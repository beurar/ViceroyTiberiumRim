...
namespace TiberiumRim
{
    public class MapComponent_TNWManager : MapComponent
    {
        ...
        private CompTNW_TNC mainController;
        ...
        public override void MapComponentUpdate()
        {
            ...
            if (DrawBool || TRUtils.GameSettings().ShowNetworkValues)
            {
                DrawTNWNetGrid();
            }
        }
        ...
        public CompTNW_TNC MainController { get => mainController; set => mainController = value; }
